	...
	<script type="text/javascript">
		$(function () {
			$("#savebutton").click(function () {
				$.ajax({
					url:"settings/dictionary/type/findSameDicType.do",
					data:{
						"code":$("#code").val()
					},
					dataType:"json",
...
<body>
	...
	<form class="form-horizontal" role="form" id="saveDicTypeFrom" action="settings/dictionary/type/saveType.do" method="post">

		<div class="form-group">
			<label for="create-code" class="col-sm-2 control-label">编码<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="code" name="code" style="width: 200%;"></br>

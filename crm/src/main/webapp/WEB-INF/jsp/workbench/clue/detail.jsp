...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            showActivityList();
            $("#activityKeyInput").keydown(function (event){
                if (event.keyCode==13){
                    $.ajax({
                        url:"workbench/clue/getActivityListByNameAndNotHave.do",
                        data:{
                            aname:$.trim($("#activityKeyInput").val()),
                            clueId:"${c.id}"
                        },
                        dataType:"json",
                        type:"post",
                    ...
                    //在模态窗口中敲回车 会刷新页面信息 使信息清空 我们不让这个默认事件发生 返回false
                    return false;
                }
            })
            $("#qx").click(function () {
            ...
            $("#bindingBut").click(function () {
               var $xz=$("input[name=xz]:checked")
                if ($xz.length==0){
                    ...
                    $.ajax({
                        url:"workbench/clue/bindingClue.do",
                        data:param,
                        dataType:"json",
                        type:"post",
                        success:function (data) {
    ...
    <div class="modal-dialog" role="document" style="width: 80%;">
        <div class="modal-content">
                    ...
                    <form class="form-inline" role="form">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" style="width: 300px;"
                                   placeholder="请输入市场活动名称，支持模糊查询" id="activityKeyInput">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="bindingBut" >关联</button>
            </div>
        </div>
    </div>
</div>
...
<div style="position: relative; left: 40px; top: -30px;">
    ...
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/toConvert.do?id=${c.id}&fullname=${c.fullname}&appellation=${c.appellation}&company=${c.company}';"><span
...
<div style="position: relative; top: -70px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 50px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${c.createBy}&nbsp;&nbsp;</b>
            <small style="font-size: 10px; color: gray;">${c.createTime}</small>
        </div>
        <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
    </div>
    <div style="position: relative; left: 40px; height: 30px; top: 60px;">
        <div style="width: 300px; color: gray;">修改者</div>
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${c.editBy}&nbsp;&nbsp;</b>
            <small style="font-size: 10px; color: gray;">${c.editTime}</small>
        </div>
        <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
    </div>
...
<div style="position: relative; top: 40px; left: 40px;">
    ...
    <div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;">
            <h5>哎呦！</h5>
            <font color="gray">线索</font> <font color="gray">-</font> <b>李四先生-蛙课网</b>

...
<head>
    ...
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            html += '<h5 id="z' + data.ar.id + '">' + data.ar.noteContent + '</h5>';
                            html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;" id="s'+data.ar.id+'"> ' + (data.ar.editFlag == 0 ? data.ar.createTime : data.ar.editTime) + ' 由' + (data.ar.editFlag == 0 ? data.ar.createBy : data.ar.editBy) + '</small>';
        ...
        function showRemarkList() {
            $.ajax({
                url: "workbench/activity/findRemarkList.do",
                data: {
                    id: "${activity.id}"
                },
                dataType: "json",
                ...
                success: function (data) {
                    ...
                    $.each(data, function (i, n) {
                        ...
                        html += '<img title="zhangsan" src="image/user-thumbnail.png" style="width: 30px; height:30px;">';
                        html += '<div style="position: relative; top: -40px; left: 40px;" >';
                        html += '<h5 id="z' + n.id + '">' + n.noteContent + '</h5>';

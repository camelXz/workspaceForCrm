    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#saveStudentBtn").click(function () {
                $.ajax({
                    url:"workbench/student/saveStudent.do",
                    data:{
                        name:$("#save-name").val(),
                        address:$("#save-address").val(),
                        phone:$("#save-phone").val(),
                        contactName:$("#save-contactName").val(),
                ...
                <form id="activitySaveFrom" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <label for="create-marketActivityName" class="col-sm-2 control-label">家庭地址<span
                                style="font-size: 15px; color: red;">*</span></label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="save-address">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control" id="save-contactName">
                        </div>
                    </div>
